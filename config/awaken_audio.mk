...
ALARM_PATH := vendor/awaken/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/awaken/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/awaken/prebuilt/common/media/audio/ringtones
